...
export const INTEL: IntelEvent[] = [
  { id: 'e1', date: '2026-06-12', country: 'EU', kind: 'rule', impact: 'high',
    ...
    body: 'Regulation (EU) 2025/1214 lets makers be judged on a three-year average for 2025–2027, easing single-year exceedances. AiRE now lets you toggle this in Admin.',
  ...
  { id: 'e9', date: '2026-04-10', country: 'EU', kind: 'rule', impact: 'medium',
    ...
    body: 'Article 11 cap unchanged. Models can still claim certified off-cycle savings up to the cap; AiRE applies MIN(model benefit, 7).',
