...
export type ScreenId = 'copilot' | 'brief' | 'overview' | 'analyse' | 'forecast' | 'scenario' | 'creditbook' | 'pricing' | 'pooling' | 'dualcredit' | 'data' | 'intel' | 'admin'
...
export const useStore = create<UIState>((set, get) => ({
  ...
  applyShared: (sh) => {
    ...
    } else if (raw && ['brief', 'overview', 'analyse', 'creditbook', 'pricing', 'pooling', 'dualcredit', 'data', 'intel', 'admin'].includes(raw)) {
